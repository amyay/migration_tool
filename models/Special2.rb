  ...
  def export
    ...
    Ticket.find_each do |t|
      ...
      if (count % batch_size == 0)
        ...
        outfile_user = File.open("./output/Users_#{sprintf('%02d',filecount)}.csv", "wb")
        outfile_group = File.open("./output/Groups_#{sprintf('%02d',filecount)}.csv", "wb")
      ...
      if (count % batch_size == 0)
        ...
        @logger.info "Created ./output/Users_#{sprintf('%02d',filecount)}.csv"
        @logger.info "Created ./output/Group_#{sprintf('%02d',filecount)}.csv"
